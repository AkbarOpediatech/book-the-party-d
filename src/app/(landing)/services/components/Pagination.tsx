...
const Pagination = ({ totalRecords, currentPage, pageLimit, handlePageChange }: IProps) => {
    ...
    <div className="flex flex-wrap items-center justify-center gap-3">
      ...
      <div className="flex flex-wrap justify-center gap-3">
        ...
        {pages[pages.length - 1] < totalPages - 1 && (
          <span className="cursor-pointer font-sora text-lg hover:text-clr-fb" onClick={handleShowMorePages}>
            ...
          </span>
        )}
